    ...
    return (
        <div >
            <div className='flex justify-between '>
                ...
                <AiOutlineMenu color='black' onClick={() => setShowNavBar(!showNavBar)} className='mt-8 mr-4 cursor-pointer ' />
            </div>
            {showNavBar &&
                <div className="absolute z-50 ">
                    <div className=' ml-44 w-32   p-5 rounded-md'>
