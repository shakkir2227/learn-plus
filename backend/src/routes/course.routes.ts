...
import { createCourse, createSubject, getAllCoursesForInstructor, getAllCoursesForLearner, getAllSubjectsForInstructor, getCourseDetails, updateCourse } from "../controllers/course.controller";
